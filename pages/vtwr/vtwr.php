...
<html>
	...
	<script language="javascript">
		window.onload = function() {
			document.getElementById('txtvendtowhsretur').focus();
		}
...
<?php
	...
	if (strlen($_SESSION['sj_number_vendor_retur'])<=1) {
		print "<script>alert('Maaf, Nomor Surat Jalan tidak boleh kosong');location.href='./../../pages/vtwr/vtwr_sj.php?proses=$proses'</script>";
	}
...
?>
		...
		<table align="center" width="200" style="border:1px solid; border-color:#CCCCCC;" >
			<tr>
              	<td align="center">
              		<button onclick="Proses('<?php echo $proses?>')">Proses To Warehouse</button>
              	</td>
              </tr>
		</table>
		...
		<form method="post" 
			  ...
			  name="vendtowhsretur" 
			  id="vendtowhsretur" action="vtwr_add.php?proses=<?php echo $proses?>">
			<table align="center" width="200" style="border:1px solid; border-colo:#CCCCCC;" >
				<tr>
					<td colspan="3">Nomor Surat Jalan DWA :</td>
				</tr>
				<tr>
					<td colspan="3"><font color="red"><b><?php echo $_SESSION['sj_number_vendor_retur']?></b><font></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3">
						<div align="center"><input type="text" name="txtvendtowhsretur" size="28" id="txtvendtowhsretur" onkeyup="hanyaAngka(this);" /></div>
					</td>
				</tr>
				<tr>
