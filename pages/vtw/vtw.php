...
<html>
	...
	<script language="javascript">
		window.onload = function() {
			document.getElementById('txtvendtowhs').focus();
		}
...
?>
		...
		<h2 align="Center">Vendor To Warehouse</h2>
		...
		<form method="post" 
			  ...
			  name="vendtowhs" 
			  id="vendtowhs" 
			  action="vtw_add.php?proses=<?php echo $proses?>">
            <table align="center" width="200" style="border:1px solid; border-color:#CCCCCC;" >
				...
				<tr>
					<td colspan="3">
						<div align="center"><input type="text" name="txtvendtowhs" size="28" id="txtvendtowhs" onkeyup="hanyaAngka(this);" /></div>
					</td>
				</tr>
				<tr>
