...
<html>
	...
	<script language="javascript">
		window.onload = function() {
			document.getElementById('txtwhstovend').focus();
		}
...
<?php
	...
	if (strlen($_SESSION['sj_number_vendor'])<=1) {
		print "<script>alert('Maaf, Nomor Surat Jalan tidak boleh kosong');location.href='./../../pages/wtv/wtv_sj.php?proses=$proses'</script>";
	}
...
?>
		...
		<table align="center" width="200" style="border:1px solid; border-color:#CCCCCC;" >
			<tr>
              	<td align="center">
              		<button onclick="Proses('<?php echo $proses?>')">Proses To Vendor</button>
              	</td>
              </tr>
		</table>
		...
		<form method="post" 
			  ...
			  name="shptocust" 
			  id="shptocust" action="wtv_add.php?proses=<?php echo $proses?>">
			<table align="center" width="200" style="border:1px solid; border-colo:#CCCCCC;" >
				<tr>
					<td colspan="3">Nomor Surat Jalan :</td>
				</tr>
				<tr>
					<td colspan="3"><font color="red"><b><?php echo $_SESSION['sj_number_vendor']?></b><font></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3">
						<div align="center"><input type="text" name="txtwhstovend" size="28" id="txtwhstovend" onkeyup="hanyaAngka(this);" /></div>
					</td>
				</tr>
				<tr>
