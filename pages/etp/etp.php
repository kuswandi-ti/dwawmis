...
<html>
	...
	<script language="javascript">
		window.onload = function() {
			document.getElementById('txtexptopro').focus();
		}
...
?>
		...
		<h2 align="center">Ekspedisi To Produksi</h2>
		<table align="center" width="200" style="border:1px solid; border-color:#CCCCCC;" >
			<tr>
              	<td align="center">
              		<button onclick="Proses('<?php echo $proses?>')">Proses To Produksi</button>
              	</td>
              </tr>
		</table>
		...
		<form method="post" 
			  ...
			  name="exptopro" 
			  id="exptopro" 
			  action="etp_add.php?proses=<?php echo $proses?>">
			<table align="center" width="200" style="border:1px solid; border-colo:#CCCCCC;" > 
				...
				<tr>
					<td colspan="3">
						<div align="center"><input type="text" name="txtexptopro" size="28" id="txtexptopro" onkeyup="hanyaAngka(this);" /></div>
					</td>
				</tr>
				<tr>
